...
export default function WhyArkamark() {
  return (
    <section id="why-arkamark" className="bg-gray-50 dark:bg-[#2a2b30] text-gray-900 dark:text-white py-[100px] px-6 md:px-20 relative overflow-hidden group/section transition-colors duration-300">
      ...
      >
         <div className="flex-1 flex items-center justify-center lg:justify-start w-full group cursor-default">
         ...
         <div className="flex-1 space-y-6 text-gray-700 dark:text-gray-300 text-lg md:text-[20px] leading-relaxed text-center lg:text-left w-full mt-4 lg:mt-0">
            <p>
